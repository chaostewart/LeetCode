class Solution {
    public List<List<String>> groupAnagrams(String[] strs) {
        ...
        Map<String, List<String>> map = new HashMap<String, List<String>>(); // Map a string (sorted charArray), to ArrayList<String>
        for (String s : strs) {  // exam each string in strs
            char[] charArray = s.toCharArray();    // these 3 steps sort the chars in string s
